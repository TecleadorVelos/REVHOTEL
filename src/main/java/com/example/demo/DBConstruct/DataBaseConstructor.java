 ...
 public class DataBaseConstructor {
	...
	*/
	/*	
		...
		h1.setHabitaciones((ArrayList<Habitacion>) Arrays.asList(hab1,hab2,hab3));
		
		hab4.setHotel(h2);
		hab5.setHotel(h2);
		hab6.setHotel(h2);
		
		h2.setHabitaciones((ArrayList<Habitacion>) Arrays.asList(hab4,hab5,hab6));
		
		hab7.setHotel(h3);
		hab8.setHotel(h3);
		hab9.setHotel(h3);
		
		h3.setHabitaciones((ArrayList<Habitacion>) Arrays.asList(hab7,hab8,hab9));
